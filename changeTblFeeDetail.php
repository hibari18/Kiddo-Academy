...
if($feeId != "")
{
    ...
    <tbody>';
    $query="select l.tblLevelId, l.tblLevelName,f.tblFeeDetailName, f.tblFeeDetailAmount from tblfeedetail f, tbllevel l where f.tblFeeDetail_tblFee = '$feeId' and f.tblFeeDetail_tblLevelId = l.tblLevelId and f.tblFeeDetailFlag = 1";
