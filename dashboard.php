                  ...
                  <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="info-box">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">Total Number of Student</span>
                          <?php
                          $query = "select * from tblstudent where tblStudentFlag = 1";
                          $result = $con->query($query);
                          $numStud = $result->num_rows;
                          ?>
                          <span class="info-box-number"><?php echo $numStud ?></span>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="info-box">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">Total Number of Faculty</span>
                            <?php
                            $query = "select * from tblfaculty where tblFacultyFlag = 1";
                            $result = $con->query($query);
                            $numFaculty = $result->num_rows;
                            ?>
                          <span class="info-box-number"><?php echo $numFaculty ?></span>
                        </div> <!-- /.info-box-content -->
                      </div> <!-- /.info-box -->
                    </div> <!-- /.col -->
                  </div> <!-- row -->
                  ...
                  <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="info-box">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">Total Number of Withdrawed Student</span>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="info-box">
                        <span class="info-box-icon bg-yellow"><i class="fa fa-group"></i></span>
                        <div class="info-box-content">
                          <span class="info-box-text">Total Number of Dismissed Students</span>
