    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <ol class="breadcrumb" style="font-size:15px;">
          ...
          <li class="active">Add Faculty Profile</li>
        </ol>
      </section>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="box box-primary" style="margin-top: 3%">
              <div class="box-header with-border"> <!-- left column -->
                      ...
                      <label class="col-lg-3 control-label">Position:</label>
                        <div class="col-sm-7">
                          <select class="form-control choose" style="width: 100%;" name="selPosition" id="selPosition">
                            ...
                            <?php
                              $query = "select * from tblfacultyposition where tblFacultyPositionFlag=1";
                              $result = mysqli_query($con, $query);
                              while($row=mysqli_fetch_array($result))
                              {
                            ?>
                            <option value="<?php echo $row['tblFacultyPositionId'] ?>"><?php echo $row['tblFacultyPositionName'] ?></option>
                            <?php } ?>
                          </select>
                        </div>
                    </div>
