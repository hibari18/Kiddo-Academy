      ...
      <ul class="sidebar-menu" style="font-size:17px;">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a class="active" href="sectionv2.php"><i class="fa fa-circle"></i>Section</a></li>
                    ...
                    <div class="box-header"></div>
                      ...
                      <div class="modal fade" id="updateModalOne" role="dialog">
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <form data-toggle="validation" role="form" action="updateSection.php" method="post" name="updSection" id="updSection">
                              <div class="modal-body">
                                <div class="form-group">
                                  <div>
                                    <input type="hidden" name="updDivId" id="updDivId"/>
                                    <input type="hidden" name="updLvlId" id="updLvlId"/>
                                    <input type="hidden" name="updSectId" id="updSectId"/>
                                  </div>
                                  <label class="col-sm-4 control-label" for="textinput" style="text-align: right">Division Name</label>
                                  <div class="col-sm-7 selectContainer">
                          ...
                          </div> <!-- odal content update -->
                        </div> <!-- modal dialog upate -->
                        ...
                        <div class="box-body">
                          <div class="box-body">
                            <table id="datatable2" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                <?php
                                  $query = "select d.tblDivisionId, d.tblDivisionName, l.tblLevelId, l.tblLevelName, s.tblSectionId, s.tblSectionName from tbldivision d, tbllevel l, tblsection s
                                ...
                                ?>
                                <tr>
                                  <td style="width:100px;" hidden><?php echo $row1['tblDivisionId']; ?></td>
        ...
        addSectTxt: {
          validators: {
            ...
            regexp: {
              ...
              message: 'Invalid Input (The first character should be an alphabet)'
            },
            notEmpty: {
