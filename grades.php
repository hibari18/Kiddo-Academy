...
<head>
  ...
  <link rel="stylesheet" href="sweetalert-master/dist/sweetalert.css">
    ...
    <link rel="stylesheet" type="text/css" href="css/validDesignGrades.css">
...
function run(){
  ...
  t.onclick=function(event){
    ...
    var f1=document.getElementById('txtId');
    var f2=document.getElementById('txtName');
    var f3=document.getElementById('txtPercent');
    var f4=document.getElementById('txtNo');
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="grades.html"><i class="fa fa-circle-o"></i>Grades</a></li>
      ...
      <div class="box-body">  
          <table id="datatable1" class="table table-bordered table-striped">
              <thead>
                ...
                <tbody>
                <?php
                $query="select * from tblgradecomponent where tblGradeFlag=1";
                $result = mysqli_query($con, $query);
                while($row=mysqli_fetch_array($result))
                {
                $percent = $row['tblGradePercent'];
                $percent = $percent * 100;
                
                ?>
                <tr>
                  <td hidden><?php echo $row['tblgradeId'] ?></td>
                  <td><?php echo $row['tblGradeName'] ?></td>
                  <td><?php echo $percent ?></td>
                  <td><?php echo $row['tblGradeNo'] ?></td>
                  <td><button type="submit" class="btn btn-success"  data-toggle="modal" data-target="#updateModalOne"><i class="fa fa-edit"></i>
                </button>
                </td>
                  </tr>
                <?php } ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title" style="font-style: bold">Update Components</h3>
        </div>
        <form autocomplete="off" data-toggle="validation" role="form" method="post" action="updateGradeComponent.php" name="updCom" id="updCom">
        <div class="modal-body">
        <input type="hidden" class="form-control" name="txtId" id="txtId">
        <div class="form-group">
            <label class="col-sm-4 control-label" for="textinput" style="text-align: right">Component</label>
            <div class="col-sm-7 selectContainer">
              <input type="text" class="form-control" readonly name="txtName" id="txtName">
            </div>
        </div>
        <div class="form-group" style="margin-top: 10%">  
            <label class="col-sm-4 control-label" for="textinput" style="text-align: right">Percentage</label>
            <div class="col-sm-7 selectContainer">
              <input type="text" class="form-control" maxlength="3" name="txtPercent" id="txtPercent">
            </div>
        </div>
        <div class="form-group" style="margin-top: 20%">  
            <label class="col-sm-4 control-label" for="textinput" style="text-align: right">Required Number</label>
            <div class="col-sm-7 selectContainer">
              <input type="text" class="form-control" maxlength="2" name="txtNo" id="txtNo">
            </div>
        </div>      
        </div>
        ...
        fields: {
          txtPercent: {
                validators: {
                    stringLength: {
                        max: 5,
                        message: 'Maximum price length is 3 digits.'
                    },
                       regexp: {
                        regexp: /^\d{1,4}[\w%]?$/,
                        message: 'This can only consist of numeric characters only.'
                    },
                        notEmpty: {
            ...
            txtNo: {
                validators: {
                    stringLength: {
                        max: 5,
                        message: 'Maximum price length is 2 digits.'
                    },
                       regexp: {
                        regexp: /^\d{1,4}?$/,
                        message: 'This can only consist of numeric characters only.'
                        ...
                        notEmpty: {
                        message: 'Required number is required'
                    }
                }
            },
            }//fields
    ...
    $('#updateModalOne')
       .on('shown.bs.modal', function () {
        ...
        .on('hidden.bs.modal', function () {
            $('#updCom').bootstrapValidator('resetForm', true);
        });
});
};
</script>
