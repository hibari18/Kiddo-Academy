              ...
              <li class="treeview">
                <a href="#">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="curriculumv2.php"><i class="fa fa-circle"></i>Curriculum</a></li>
                  ...
                  <div class="nav-tabs-custom">
                              ...
                              <div class="modal fade" id="updateModalThree" role="dialog">
                                <div class="modal-dialog">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form autocomplete="off" data-toggle="validator" method="post" action="updateDivision.php" name="UpdDivision" id="UpdDivision">
                                      <div class="modal-body">
                                        <div class="form-group"  style="margin-top: 5%">
                                ...
                                <tbody>
                                  ...
                                  while($row = mysqli_fetch_array($result))
                                  {
                                    ...
                                    <tr>
                                      ...
                                      <td style="width:100px;"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#updateModalThree"><i class="fa fa-edit"></i></button></td>
                                    </tr>
                                    <?php } ?>
                                  </tbody>
                                </table>
                              ...
                              <div class="modal fade" id="addModalFour" role="dialog">
                                ...
                                <!-- Modal content-->
                                  <div class="modal-content">
                                   ...
                                   <form autocomplete="off" data-toggle="validator" role="form" method="post" action="saveLevel.php" name="addLevel" id="addLevel">
                                     <div class="modal-body">
                                       <div class="form-group" style="margin-top: 5%">
                    ...
                    <!--modal delete end-->
                            <table id="datatable4" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                <?php
                                $query = "select tblSubjectId, tblSubjectDesc, tblSubjectActive from tblsubject where tblSubjectFlag = 1";
                                $result = mysqli_query($con, $query);
                                ...
                                <tr>
                                  ...
                                  <td style="width:100px;"><?php echo $row['tblSubjectActive']; ?></td>
            ...
            fields: {
              txtAddSubjId: {
                validators: {
                  ...
                  regexp: {
                    regexp: /^[a-zA-Z_][0-9a-zA-Z_][\w-'\s]+$/,
                    message: 'Invalid Input (The first letter must be an alphabet)'
                  },
                  notEmpty: {
            ...
            fields: {
              txtUpdSubj: {
                validators: {
                  ...
                  regexp: {
                    regexp: /^[a-zA-Z_][0-9a-zA-Z_][\w-'\s]+$/,
                    message: 'Invalid Input (The first charater must be an alphabet)'
                  },
                  notEmpty: {
                    message: 'Curriculum name is required'
                  }
