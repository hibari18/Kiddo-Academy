...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="grades.php"><i class="fa fa-circle-o"></i>Grades</a></li>
            <li><a href="sectionv2.php"><i class="fa fa-circle-o"></i>Section</a></li>
            <li><a href="schedulev2.php"><i class="fa fa-circle-o"></i>Schedule</a></li>
            ...
            <li><a href="facultyv2.php"><i class="fa fa-circle-o"></i>Faculty Assignment</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pre-admission.html"><i class="fa fa-circle-o"></i>Pre-Admission</a></li>
            <li><a href="tag-passed.html"><i class="fa fa-circle-o"></i>Tag Passed Applicants</a></li>
            ...
            <li><a href="enrollment.html"><i class="fa fa-circle-o"></i>Enrollment</a></li>
             <li><a href="view-gradesv2.html"><i class="fa fa-circle-o"></i>View Grades</a></li>
            <li><a href="sectioningv2.html"><i class="fa fa-circle-o"></i>Sectioning</a></li>
            <li><a href="transferee-credentialsv2.html"><i class="fa fa-circle-o"></i>Transferee Credentials</a></li>
          ...
          <div class="box box-primary">
            ...
            <div class="form-group" style="margin-top: 3%">
                      ...
                      <select class="form-control choose" style="width: 100%;">
                        ...
                        <option>Nursery - Obedient</option>
                      </select>
                      </div>
              </div>
              </div>
  ...
  <div class="modal fade" id="modalEditMonday" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="form-group" style="margin-top: 7%">  
            <label class="col-sm-4 control-label" style="text-align: right">Subject Code:</label>
           <div class="col-sm-7">
               <input type="text" class="form-control" disabled>
              </div>
        </div>
        <div class="form-group" style="margin-top: 17%">
                 <label class="col-sm-4 control-label" style="text-align: right">Subject Name:</label>
           <div class="col-sm-7">
                <select class="form-control choose" style="width: 100%;">
  ...
  <div class="modal fade" id="modalDeleteMonday" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h3 class="modal-title" style="font-style: bold">Delete Schedule</h3>
        </div>
    ...
    <div class="modal fade" id="modalEditTuesday" role="dialog">
    <div class="modal-dialog">
  ...
  <div class="modal fade" id="modalDeleteTuesday" role="dialog">
    <div class="modal-dialog">
    ...
    <div class="modal fade" id="modalEditWed" role="dialog">
    <div class="modal-dialog">
  ...
  <div class="modal fade" id="modalDeleteWed" role="dialog">
    <div class="modal-dialog">
    ...
    <div class="modal fade" id="modalEditThurs" role="dialog">
    <div class="modal-dialog">
  ...
  <div class="modal fade" id="modalDeleteThurs" role="dialog">
    <div class="modal-dialog">
    ...
    <div class="modal fade" id="modalEditFri" role="dialog">
    <div class="modal-dialog">
  ...
  <div class="modal fade" id="modalDeleteFri" role="dialog">
    <div class="modal-dialog">
             ...
             <div class="box-body">
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalEditMonday"><i class="fa fa-edit"></i></button>
                  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalDeleteMonday"><i class="fa fa-trash"></i></button>
                  </td>
                </tr>
                </tbody>
              </table>
             ...
             <div class="box-body">
              <table id="datatable1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>10:30AM-12:00PM</td>
                  <td>
                  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalEditTuesday"><i class="fa fa-edit"></i></button>
                  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalDeleteTuesday"><i class="fa fa-trash"></i></button>
                  </td>
                </tr>
                </tbody>
              </table>
             ...
             <div class="box-body">
              <table id="datatable2" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>10:30AM-12:00PM</td>
                  <td>
                  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalEditWed"><i class="fa fa-edit"></i></button>
                  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalDeleteWed"><i class="fa fa-trash"></i></button>
                  </td>
                </tr>
                </tbody>
              </table>
             ...
             <div class="box-body">
              <table id="datatable3" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>10:30AM-12:00PM</td>
                  <td>
                  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalEditThurs"><i class="fa fa-edit"></i></button>
                  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalDeleteThurs"><i class="fa fa-trash"></i></button>
                  </td>
                </tr>
                </tbody>
              </table>
             ...
             <div class="box-body">
              <table id="datatable4" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalDeleteFri"><i class="fa fa-trash"></i></button>
                  </td>
                </tr>
                </tbody>
              </table>
